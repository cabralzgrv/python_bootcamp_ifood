...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print("\n@@@ A operação falhou!Valor invalido @@@")
...
def filtrar_usuarios(cpf, usuarios):
    usuarios_filtrados = [] 
    usuarios_filtrados[0] = [usuario for usuario in usuarios if usuario["cpf"]==cpf]
...
def main():
    ...
    while True:
        ...
        if opcao == 'd':
            ...
            print("Operação inválida, por favo selecione novamente.")
